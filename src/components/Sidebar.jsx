function Sidebar({projects, setCurrentIndex, setProjectState}){
    ...
    return (
                <aside className="bg-black rounded-tr-lg h-full w-1/3 flex flex-col items-center outline outline-white">
                    <h1 className="text-center mt-4 text-2xl font-medium">Your projects</h1>
                    <button className="mt-6 mb-3 w-10/12 bg-gradient-to-r from-pink-400 
                    to-blue-500 rounded-lg py-2 px-4 text-lg outline-3 outline outline-white 
